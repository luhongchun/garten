...
<div data-role="page">
    <div data-role="content">
        ...
        <c:url var="formAction" value="/video/manage/downloadByPerson/start"/>
        <form method="post" name="form_data" id="form_data" action="${formAction}">
            <div>
                <h4>班级与对应设备ID</h4>
            </div>
            <div>
                <input type="text" id="class2Cameras" name="class2Cameras" placeholder="中一班:ff1231f,fasdas" required="required">
            </div>
            <div>
                <h4>孩子的人脸识别信息</h4>
            </div>
            <div>
                <input type="text" id="frName2Id" name="frName2Id" placeholder="姚小宝:ff1231f;姚大宝:ff803cd56" required="required">
            </div>
            <div>
                <h4>日期选择</h4>
            </div>
