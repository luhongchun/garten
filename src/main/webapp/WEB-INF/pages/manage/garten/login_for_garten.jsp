...
<body onload="document.getElementById('login_identity').focus();">
	<div data-role="page">
		<div data-role="main" class="ui-content jqm-content">
			<div style="width:90%;max-width:450px; margin:auto;">
				<form name="loginForm" id="loginForm" method="post"
						action='${ctx}/security/loginManager'>
					<h4>账&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;户：</h4>
					...
					<h4>校&nbsp;验&nbsp;码：</h4>
					<input id="verifyCode" name="verifyCode" class="input" tabindex="3" />
					<img id="verifyCodeImg" name="verifyCodeImg" src="${ctx}/security/captcha" onclick="changeVerifyCode();" alt="点击图片，换一张"/>
