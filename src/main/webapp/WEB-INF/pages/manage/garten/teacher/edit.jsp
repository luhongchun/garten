...
<body>
	<div data-role="page">
		...
		<div data-role="content">
			<c:url var="formEditAction" value="/garten/manage/teacher/edit_submit" />
			<c:url var="formDelAction" value="/garten/manage/teacher/del_submit" />
			<form method="post" name="form_data" id="form_data">
				<input type="hidden" name="TokenName" value="${session.TokenName}">
				<input type="hidden" name="gartenId" value="${gartenId}">
				<input type="hidden" name="teacherId" value="${teacher.id}">

				<div class="ui-field-contain">
					<label for="name">姓名<font color="RED"> <strong>*</strong></font></label>
					<input type="text" id="name" name="name" placeholder="请输入姓名"
						required="required" data-clear-btn="true" value="${teacher.aliasName }">
				</div>
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#backBtn").click(function() {
				new submitForm('${ctx}/garten/manage/teacher/list', { gartenId:'${gartenId}' }).post();
			});
