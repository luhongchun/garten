...
<div class="weui_msg">
  <div class="weui_icon_area">
    <img src="http://static-10001988.cos.myqcloud.com/resource/images/icons/403.png" width="96px"></img>
  </div>

  <div class="weui_text_area">
    <h2 class="weui_msg_title">请求被拒</h2>
    <p class="weui_msg_desc">您所在的用户组暂时无法访问</p>
  </div>
